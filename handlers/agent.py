...
def _main_prompt() -> str:
    return (
        ...
        "IMPORTANT: Messages are wrapped with <sender>username</sender> to show who sent them. "
        "The sender tag is METADATA ONLY. NEVER include the sender username in any search query or tool call. "
        "When searching, use ONLY the actual question — completely ignore the <sender> tag. "
