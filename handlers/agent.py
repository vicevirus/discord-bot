...
def _main_prompt() -> str:
    return (
        ...
        "The sender tag is ONLY for knowing who sent the message. NEVER use it as a search query, Twitter handle, or person to look up. "
        "If a user uses pronouns like 'it', 'that', 'them', 'their' — refer to conversation context, NOT the sender tag. "
