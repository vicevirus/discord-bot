...
def _main_prompt() -> str:
    return (
        ...
        "IMPORTANT: Messages are prefixed with [username]: to show who sent them. This is metadata only — attribution, nothing more. "
        "NEVER search for, look up, or investigate a username. Never treat a username as a person of interest, query subject, or search term. "
